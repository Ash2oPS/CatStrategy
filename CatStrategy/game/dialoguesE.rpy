label dialogueE1:
    ...
    menu:   #"menu:" veux dire qu'on va proposer un choix au joueur
        ...
        " Payer 40 brins de Catnabis pour prendre parole." if argent >= 40 :  #un texte avec :  après c'est l'un des choix pour le joueur, le tete entre guillemets c'est ce que verra le joueur
            if randomChance == 1:    #Une chance sur trois que ça se passe bien
                ...
                if not clan1Vivant:    #si le clan 1 est mort, le clan 2 prend tout
                    $ membreClan2 -= 4

                elif not clan2Vivant:
                    $ membreClan1 -= 4
     ...
     #a la fin on reviens aux label dialogue qui va choisir un autre dialogue
    jump dialogue
...
label dialogueE4:
    ...
    menu:   #"menu:" veux dire qu'on va proposer un choix au joueur
        ...
        "Construire un nouveau silo pour 30 Catnabis." if argent >= 30:  #un texte avec :  après c'est l'un des choix pour le joueur, le tete entre guillemets c'est ce que verra le joueur
            chat "C’est une sage décision, chef !"
            $ argent -= 30
            $ eauMax += 50
...
label dialogueE5:
    ...
    menu:   #"menu:" veux dire qu'on va proposer un choix au joueur
        ...
        "Améliorer les fermes à Catnabis pour 30 Catnabis."if argent >= 30:  #un texte avec :  après c'est l'un des choix pour le joueur, le tete entre guillemets c'est ce que verra le joueur
...
label dialogueE7:
    menu:   #"menu:" veux dire qu'on va proposer un choix au joueur
        ...
        "Améliorer le camp de Chats-seurs pour 30 Catnabis"if argent >= 30:  #un texte avec :  après c'est l'un des choix pour le joueur, le tete entre guillemets c'est ce que verra le joueur
            chat "Très bien, je me mets au travail !"
            $ argent -= 30
            $ boostRecolte += 0.1
...
label dialogueE9:
    ...
    menu:   #"menu:" veux dire qu'on va proposer un choix au joueur
        ...
        "Payer 20 Catnabis pour financer de nouveaux films."if argent >= 20:  #un texte avec :  après c'est l'un des choix pour le joueur, le tete entre guillemets c'est ce que verra le joueur
...
label dialogueE10:
    ...
    menu:   #"menu:" veux dire qu'on va proposer un choix au joueur
        ...
        "Lui donner les 5 rats"if nourriture >= 5:  #un texte avec :  après c'est l'un des choix pour le joueur, le tete entre guillemets c'est ce que verra le joueur
...
label dialogueE12:
    ...
    menu:   #"menu:" veux dire qu'on va proposer un choix au joueur
        ...
        " Payer 40 Catnabis pour une campagne publicitaire."if argent >= 40:  #un texte avec :  après c'est l'un des choix pour le joueur, le tete entre guillemets c'est ce que verra le joueur
            if randomChance == 1:    #Une chance sur trois que ça se passe bien
        ...
        "Payer 10 rats pour un spectacle inter-clan."if nourriture >= 10:  #Deuxième choix du joueur
            if randomChance == 1:
...
label dialogueE16:
    ...
    menu:
        chat "Chef, regardez, j’ai trouvé de quoi remplir 30 d’un silo d’eau. Je vous propose ça contre 8 rats. Entendu ?"
