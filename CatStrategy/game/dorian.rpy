...
screen choix_clan: #À FIX le selected_idle fait n'imp
    imagebutton:
        ...
        action SetVariable ("nourriture", 3), SetVariable ("eau", 100), SetVariable ("argent", 150), SetVariable ("membre", 33), SetVariable("portraitJoueur", "portrait_clan_1.png"), SetVariable("membreClan1", 40), SetVariable("membreClan2", 27), SetVariable("choixClan", True)
    ...
    imagebutton:
        ...
        action SetVariable ("nourriture", 100), SetVariable ("eau", 100), SetVariable ("argent", 250), SetVariable ("membre", 27), SetVariable("portraitJoueur", "portrait_clan_2.png"), SetVariable("membreClan1", 40), SetVariable("membreClan2", 33), SetVariable("choixClan", True)
    ...
    imagebutton:
        ...
        action SetVariable ("nourriture", 75), SetVariable ("eau", 100), SetVariable ("argent", 200), SetVariable ("membre", 40), SetVariable("portraitJoueur", "portrait_clan_3.png"), SetVariable("membreClan1", 33), SetVariable("membreClan2", 27), SetVariable("choixClan", True)
    frame:
        xalign 0.5
        yalign 0.8
...
screen negociation: #Ecran lors d'une negociation avec un clan adverse
...
label test_random_ressource:    #Ressource aléatoire du clan afficher après un combat

    $ nourritureAdv = renpy.random.randint(membreClan1*2-10,membreClan1*2+10)
    $ eauAdv = renpy.random.randint(0,100)
    $ argentAdv = renpy.random.randint(membreClan1*3-20,membreClan1*3+20)
    "nourriture adverse : [nourritureAdv]\nEau adverse : [eauAdv]\nArgent adverse : [argentAdv]\nMembre adverse : [membreClan1]"
